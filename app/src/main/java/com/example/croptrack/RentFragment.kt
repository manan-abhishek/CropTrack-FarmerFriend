...
class RentFragment : Fragment() {
    ...
    private fun navigateToDetail(name: String, description: String, imageResId: Int) {
        val intent = Intent(requireContext(), EquipmentDetailsActivity::class.java).apply {
            putExtra("name", name)
